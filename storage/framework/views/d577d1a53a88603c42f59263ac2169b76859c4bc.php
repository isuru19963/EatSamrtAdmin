            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <div class="page-header-title">
                        <h4 class="m-b-10"><?php echo e(__('Motivational Message')); ?></h4>
                    </div>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item active"><a href="<?php echo e(route('home')); ?>"><?php echo e(__('Dashboard')); ?></a></li>
                        <li class="breadcrumb-item active"><a href="<?php echo e(route('motivational-messages.index')); ?>"><?php echo e(__('Motivational Message')); ?></a>
                        </li>
        ...
        <div class="col-md-12 m-auto">
            <div class="card">
                <div class="card-header">
                    <h5><?php echo e(__('Create Motivational Message')); ?></h5>
                </div>
                <div class="card-body">
                    <?php echo Form::open(['route' => 'motivational-messages.store', 'method' => 'Post', 'enctype' => 'multipart/form-data']); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/EatSmartApp/resources/views/motivational_messages/create.blade.php ENDPATH**/ ?>