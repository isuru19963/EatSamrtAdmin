<div class="btn-group me-2">
    ...
    <div class="dropdown-menu table-dropdown p-0">
        <a class="dropdown-item"  href="<?php echo e(route('fooditems.edit', $category->id)); ?>" >
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/EatSmartAdmin/resources/views/all_exercises/action.blade.php ENDPATH**/ ?>