<div class="btn-group me-2">
    ...
    <div class="dropdown-menu table-dropdown p-0">
        <a class="dropdown-item"  href="<?php echo e(route('badge.edit', $category->id)); ?>" >
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/EatSmartApp/resources/views/badge/action.blade.php ENDPATH**/ ?>