<div class="btn-group me-2">
    ...
    <div class="dropdown-menu table-dropdown p-0">
        <a class="dropdown-item"  href="<?php echo e(route('article.edit', $category->id)); ?>" >
            <i class="ti ti-edit"></i><?php echo e(__(' Edit')); ?>

        </a>
        <?php echo Form::open(['method' => 'DELETE', 'route' => ['article.destroy', $category->id], 'id' => 'delete-form-' . $category->id]); ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/STARTADMIN/resources/views/articles/action.blade.php ENDPATH**/ ?>