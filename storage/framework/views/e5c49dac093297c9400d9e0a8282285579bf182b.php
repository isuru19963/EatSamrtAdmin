            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="<?php echo e(route('blogs.index')); ?>"><?php echo e(__('Badge')); ?></a>
                        </li>
        ...
        <div class="col-md-12 m-auto">
            <div class="card">
                <div class="card-header">
                    <h5><?php echo e(__('Create Badge')); ?></h5>
                </div>
                <div class="card-body">
                    <?php echo Form::open(['route' => 'badge.store', 'method' => 'Post', 'enctype' => 'multipart/form-data']); ?>

                    <div class="form-group">
                        <?php echo e(Form::label('interval_time', __('Interval Time in word(1 Week)'), ['class' => 'form-label'])); ?> *
                        <?php echo Form::text('interval_time', null, ['class' => 'form-control', 'placeholder' => 'Enter Interval Time in word', 'required' => 'required']); ?>

                    </div>
                    <div class="form-group">
                        <?php echo e(Form::label('time', __('Interval time in seconds'), ['class' => 'form-label'])); ?> *
                        <?php echo Form::text('time', null, ['class' => 'form-control', 'placeholder' => 'Enter Interval time in seconds', 'required' => 'required']); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/EatSmartApp/resources/views/badge/create.blade.php ENDPATH**/ ?>