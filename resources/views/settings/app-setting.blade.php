                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h4 class="m-b-10">System Settings</h4>
                            </div>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('home') }}">{{ __('Dashboard') }}</a></li>
                                <li class="breadcrumb-item"><a href="{{ route('settings') }}">{{ __('System Settings') }}</a></li>
                                    ...
                                    <div class=" row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group bg-light text-center">
                                                <img id="app-dark-logo"
                                                    ...
                                                    src="{{asset('assets/images/badges/logos/app-logo.png') }}" alt="App_logo">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group bg-light text-center">
                                                <img id="app-dark-logo"
                                                    class=" img-responsive my-5 w-100 justify-content-center text-center"
                                                    src="{{asset('assets/images/badges/logos/app-small-logo.png') }}" 
                                                    alt="app_small_logo">
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group bg-light text-center">
                                                <img id="app-dark-logo"
                                                    ...
                                                    src="{{asset('assets/images/badges/logos/app-favicon-logo.png') }}" 
                                                    alt="favicon_logo">
                                            </div>
                                            <div class="form-group">
