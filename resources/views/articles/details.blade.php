                                    ...
                                    <div id="carouselExampleCaptions" class="carousel slide carousel-fade"
                                        ...
                                        <div class="carousel-inner custom-carousel-inner">
                                            <div class="carousel-item active ">
                                                <img src="{{ asset('assets/images/articles/'.$post->photo) }}"
                                                style="width:300px;height:300px;" alt="Product images">
                                            </div>
                                            ...
                                            <div class="col-lg-3 col-md-6">
                                                <div class="card mb-3">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        {{-- {{-- <a href="{{ route('article.details', $post->slug) }}">Read More <i
                                                        class="fas fa-chevron-right"></i></a> --}}

                                                        <div class="article-cta">
                                                            <a href="{{ route('article.details', $post->slug) }}">{{__('Read
