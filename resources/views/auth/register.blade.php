...
@section('content')
        <div class="mx-3 mx-md-5 mb-5" style="margin-top:2px;">
        <img src="{{ asset('assets/images/logos/app-logo.png') }}" alt="logo" class="app-logo mt-5" width="400">
    </div>
        <div class="card">
                        ...
                        <div class="form-group">
                            <div class="d-flex align-items-center">
                                ...
                                <label class="form-check-label"
                                    for="agree">{{ __('I agree with') }}<a href="https://stopcannabischallenge.ca/terms-conditions" target="_blank"
                                    >{{ __(' Terms and Conditions') }}</a></label>
