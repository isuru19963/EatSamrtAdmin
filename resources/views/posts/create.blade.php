            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea  name="description" rows="10" class="tinymce" placeholder="@lang('Your message')" ></textarea>
                        <!-- {!! Form::textarea('description', null, ['class' => 'form-control tinymce', 'placeholder' => 'Enter description', 'required' => 'required']) !!} -->
                    </div>
                </div>
