...
use App\Http\Controllers\ChallengeRequestController;
use App\Http\Controllers\BadgesController;
use App\Http\Controllers\FoodItemController;
use App\Http\Controllers\ChallengesController;
use App\Http\Controllers\AllExersicesController;
use App\Http\Controllers\UserBadgesController;
use App\Http\Controllers\LibraryController;
use App\Http\Controllers\LeaderBoardController;
use App\Http\Controllers\ArticlesController;
use App\Http\Controllers\MotivationalMessageController;
use App\Http\Controllers\BaselineSurveyController;
use App\Http\Controllers\EcologicalSurveyController;
...
use App\Http\Controllers\Sessions4Controller;
use App\Http\Controllers\AllSessionController;
...
Route::get('/import-csv-patient', [CSVController::class, 'importPatientCsv']);
Route::get('/import-csv-testdata', [CSVController::class, 'importTestForClient']);
...
Route::group(['middleware' => ['Setting', 'xss']], function () {
    ...
    Route::get('article-details/{slug}', [ArticlesController::class, 'article_details'])->name('article.details');


    Route::get('view-article', [ArticlesController::class, 'all_article'])->name('view.article');
});
...
Route::post('article/updatedata/{id}', [ArticlesController::class, 'update'])->name('article.updatedata');
Route::group(['middleware' => ['auth', 'Setting', 'xss', '2fa']], function () {
    ...
    Route::resource('challenge', ChallengesController::class);

    
    Route::resource('library', LibraryController::class);
    // Route::get('badge/create', [BadgesController::class, 'create'])->name('badge.create');
    ...
    Route::get('/cron/run',[RequestDomainController::class, 'cron'])->name('cron');
