...
class AllExersicesDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        ->addColumn('action', function (FoodsOrder $category) {
            return view('all_exercises.action', compact('category'));
        })
        ->editColumn('status', function (FoodsOrder $category) {
        ...
        ->editColumn("image", function (FoodsOrder $post) {
    ...
    public function query(FoodsOrder $model)
    {
        // if (tenant('id')==null) {
