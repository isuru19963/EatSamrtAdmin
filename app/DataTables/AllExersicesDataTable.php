...
class AllExersicesDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        ->addColumn('action', function (AllExersices $category) {
            return view('all_exercises.action', compact('category'));
        })
        ->editColumn('status', function (AllExersices $category) {
        ...
        ->editColumn("image", function (AllExersices $post) {
            return "<img src=" .asset('assets/images/exersice/'.$post->image). " width='100' />";
        })
    ...
    public function query(AllExersices $model)
    {
        // if (tenant('id')==null) {
            ...
            ->parameters([
                ...
                'buttons'   => [
                    ['extend' => 'create', 'className' => 'btn btn-primary btn-sm no-corner add_module', 'action' => " function ( e, dt, node, config ) {
                        window.location = '" . route('allExersices.create') . "';
    ...
    {return 
        ...
        [
            ...
            Column::make('exerciser_name')->title(__('Name')),
