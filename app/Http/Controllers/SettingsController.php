...
class SettingsController extends Controller
{
    ...
    public function appNameUpdate(Request $request)
    {
        ...
        if ($request->app_logo) {
            ...
            $request->app_logo->move(public_path('assets/images/logos'), $app_logo_name);
        ...
        if ($request->app_dark_logo) {
            ...
            $request->app_dark_logo->move(public_path('assets/images/logos'), $app_dark_logo_name);
        ...
        if ($request->favicon_logo) {
            ...
            $request->favicon_logo->move(public_path('assets/images/logos'), $favicon_logo_name);
